    ...
    public static void animateMarkerToGB(final Marker marker, final LatLng finalPosition, final LatLngInterpolator latLngInterpolator) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                //for marker rotation
                // perfect solution.+1.Just need to set anchor to the marker(0.5f,0.5f). Good job @Prasad – Abhishek Pachal

                double toRotation = bearingBetweenLocations(marker.getPosition(), finalPosition);
